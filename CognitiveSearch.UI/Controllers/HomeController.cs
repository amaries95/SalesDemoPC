...
using CognitiveSearch.UI.ViewModels;
using CognitiveSearch.UI.AzureManagement;
...
namespace CognitiveSearch.UI.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public DocumentsRetrievedViewModel SearchView([FromForm]SearchOptions searchParams)
        {
